...
class Foo
{
    ...
    public function aggregateFunctions(PDO $pdo)
    {
        ...
        assertType('PDOStatement<array{max: int<-32768, 32767>|null, min: int<-32768, 32767>|null, count: int, avg: string|null}>', $stmt);
    }
}
